...
function Form() {
    ...
    // To connect to API for functionality
    ...
    return (
        <>
            <form action="" onSubmit={handleSubmit}>
                ...
                <div className="d-flex mt-3">
                    <div className="flex-grow-1 me-2">
                        <input type="tel" name='phone' value={formData.phone} placeholder='Phone (Optional)' className='form-control' onChange={handleChange} />
                    </div>
                    <div className="flex-grow-1 ms-2">
                ...
                <textarea name="message" value={formData.message} id="" cols="30" rows="10" className={`form-control mt-3 ${errors.message && 'is-invalid'}`} placeholder='Enter your message here' onChange={handleChange}></textarea>
